...
bool CLAS_Info::On_Execute(void)
{
	...
	LAS_READER reader(ifs);
	LAS_HEADER const& header = reader.GetHeader();
...
//---------------------------------------------------------
bool CLAS_Info::Print_Header(CSG_String fName, LAS_HEADER header)
{
...
//---------------------------------------------------------
bool CLAS_Info::Print_Point_Summary(LAS_HEADER header, LASPointSummary *pSummary)
{
	long rgpsum		= 0;
	long pbretsum	= 0;
	int	i			= 0;
...
//---------------------------------------------------------
bool CLAS_Info::Summarize_Points(LAS_READER *pReader, LASPointSummary *pSummary, int headerPts)
{
	LAS_COLOR	color;
	LAS_COLOR	min_color;
	LAS_COLOR	max_color;
